...
namespace HikiCarry.Core.Plugins
{
    ...
    public class DetectedSpellData
    {
        ...
        public AIBaseClientProcessSpellCastEventArgs Args;

        public void Set(SpellData s, Vector2 sp, Vector2 ep, AIBaseClient snd, AIBaseClientProcessSpellCastEventArgs ar)
        {
            Spell = s;
            StartPosition = sp;
            EndPosition = ep;
