...
namespace EzAIO.Champions.Jinx
{
    sealed class Jinx : ChampionBases
    {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            {
                DrawCircle(GameObjects.Player.Position,Extension.RocketRange,Color.Cyan);
            }
            if (DrawingBase.DrawMenu.WBool.Enabled)
            {
                DrawCircle(GameObjects.Player.Position,W.Range,Color.Cyan);
            }
            if (DrawingBase.DrawMenu.EBool.Enabled)
            {
                DrawCircle(GameObjects.Player.Position,E.Range,Color.Cyan);
            }
            if (DrawingBase.DrawMenu.RBool.Enabled)
            {
