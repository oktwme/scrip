...
namespace EzAIO.Champions.Lucian
{
    ...
    class Damage
    {
        ...
        private static readonly float[] RBaseDamage = {0f, 15f, 30f, 45f, 45f};
        private static readonly float[] RShots = {0, 30, 60, 90, 90};
        ...
        public static float RDamage(AIBaseClient target)
        {
            ...
            var rBaseDamage = RBaseDamage[rLevel] +
                              ...
                              .15 + GameObjects.Player.TotalMagicalDamage;
