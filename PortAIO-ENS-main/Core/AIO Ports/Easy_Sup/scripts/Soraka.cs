...
namespace Easy_Sup
{
    class Soraka
    {
        ...
        private static void AutoR()
        {
            ...
            var ally = GameObjects.AllyHeroes.Where(x => x.IsAlly && x.IsValidTarget(float.MaxValue, false) && x.HealthPercent <= Menubase.soraka_ultimate.rHeal.Value).Cast<AIHeroClient>().ToList();
        ...
        private static void Combo()
        {
            ...
            if (useQ.Enabled && Q.IsReady() && prediction.Hitchance >= HitChance.High)
            {
