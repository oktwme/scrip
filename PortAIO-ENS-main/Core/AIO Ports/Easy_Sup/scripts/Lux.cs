...
namespace Easy_Sup.scripts
{
    class Lux
    {
        ...
        public static void Load()
        {
            ...
            Q.SetSkillshot(0.5f, 80, 1200, false, SpellType.Line);
            W.SetSkillshot(0.5f, 150, 1200, false, SpellType.Line);
            E.SetSkillshot(0.5f, 275, 1300, false, SpellType.Circle);
            R.SetSkillshot(1.75f, 190, 3000, false, SpellType.Line);
        ...
        public static bool EActivated
        {
            get
            {
                return ObjectManager.Player.Spellbook.GetSpell(SpellSlot.E).ToggleState == (SpellToggleState) 1 || EGameObject != null;
            }
        }
        ...
        private static void DoCombo()
        {
            ...
            if (useW && W.IsReady() && ObjectManager.Player.HealthPercent <= Menubase.lux_w.Wper.Value)
            {
