        ...
        public class DrawOption
        {
            ...
            public static void AddRange(Spell spell, string name, bool enabled = false)
            {
                ...
                Drawing.OnDraw += delegate
                {
                    ...
                    {
                        CircleRender.Draw(ObjectManager.Player.PreviousPosition, spell.Range, Color.FromArgb(199, 5, 255).ToSharpDxColor(), 1);
                    }
                };
            }
            ...
            public static void AddQ(Spell spell, bool enabled = false)
            {
                ...
                Drawing.OnDraw += delegate
                {
                    ...
                    {
                        CircleRender.Draw(ObjectManager.Player.PreviousPosition, spell.Range, Color.FromArgb(19, 130, 234).ToSharpDxColor(), 1);
                    }
                };
            }
            ...
            public static void AddW(Spell spell, bool enabled = false)
            {
                ...
                Drawing.OnDraw += delegate
                {
                    ...
                    {
                        CircleRender.Draw(ObjectManager.Player.PreviousPosition, spell.Range, Color.FromArgb(248, 246, 6).ToSharpDxColor(), 1);
                    }
                };
            }
            ...
            public static void AddE(Spell spell, bool enabled = false)
            {
                ...
                Drawing.OnDraw += delegate
                {
                    ...
                    {
                        CircleRender.Draw(ObjectManager.Player.PreviousPosition, spell.Range, Color.FromArgb(188, 6, 248).ToSharpDxColor(), 1);
                    }
                };
            }
            ...
            public static void AddR(Spell spell, bool enabled = false)
            {
                ...
                Drawing.OnDraw += delegate
                {
                    ...
                    {
                        CircleRender.Draw(ObjectManager.Player.PreviousPosition, spell.Range, SharpDX.Color.Red, 1);
                    }
                };
            }
            ...
            public static void AddQExtend(Spell spell, bool enabled = false)
            {
                ...
                Drawing.OnDraw += delegate
                {
                    ...
                    if (spellMenu["DrawQExtend"].GetValue<MenuBool>().Enabled && 
                        ...
                        ObjectManager.Player.Spellbook.CanUseSpell(SpellSlot.Q) == SpellState.Ready)
                    {
                        CircleRender.Draw(ObjectManager.Player.PreviousPosition, spell.Range, Color.FromArgb(0, 255, 161).ToSharpDxColor(), 1);
                    }
                };
            }
        }
