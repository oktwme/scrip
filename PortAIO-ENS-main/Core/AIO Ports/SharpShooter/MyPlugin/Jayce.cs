...
namespace SharpShooter.MyPlugin
{
    public class Jayce : MyLogic
    {
        ...
        private static void Initializer()
        {
            ...
            Q.SetSkillshot(0.25f, 79f, 1200f, true, SpellType.Circle);

            Q2 = new Spell(SpellSlot.Q, 600f) { Speed = float.MaxValue, Delay = 0.25f };

            QE = new Spell(SpellSlot.Q, 1650f);
            QE.SetSkillshot(0.35f, 98f, 1900f, true, SpellType.Circle);
            ...
            E.SetSkillshot(0.1f, 120f, float.MaxValue, false, SpellType.Circle);
            ...
            MyMenuExtensions.ComboOption.AddBool("UsQECombo", "Use Cannon Q");
            MyMenuExtensions.ComboOption.AddBool("UseWCombo", "Use Cannon W");
            MyMenuExtensions.ComboOption.AddBool("UseECombo", "Use Cannon E");
            MyMenuExtensions.ComboOption.AddBool("UsQEComboHam", "Use Hammer Q");
            MyMenuExtensions.ComboOption.AddBool("UseWComboHam", "Use Hammer W");
            MyMenuExtensions.ComboOption.AddBool("UseEComboHam", "Use Hammer E");
            MyMenuExtensions.ComboOption.AddBool("UseRCombo", "Use R Switch");

            MyMenuExtensions.HarassOption.AddMenu();
            MyMenuExtensions.HarassOption.AddBool("UsQEHarass", "Use Cannon Q");
            MyMenuExtensions.HarassOption.AddBool("UseWHarass", "Use Cannon W");
            MyMenuExtensions.HarassOption.AddBool("UseEHarass", "Use Cannon E");
            MyMenuExtensions.HarassOption.AddBool("UsQEHarassHam", "Use Hammer Q", false);
            MyMenuExtensions.HarassOption.AddBool("UseWHarassHam", "Use Hammer W", false);
            MyMenuExtensions.HarassOption.AddBool("UseEHarassHam", "Use Hammer E", false);
            MyMenuExtensions.HarassOption.AddBool("UseRHarass", "Use R Switch");
            MyMenuExtensions.HarassOption.AddMana(60);
            MyMenuExtensions.HarassOption.AddTargetList();

            MyMenuExtensions.LaneClearOption.AddMenu();
            MyMenuExtensions.LaneClearOption.AddBool("UsQEFarm", "Use Cannon Q");
            MyMenuExtensions.LaneClearOption.AddBool("UseRFarm", "Use R Switch");
            MyMenuExtensions.LaneClearOption.AddMana();

            MyMenuExtensions.JungleClearOption.AddMenu();
            MyMenuExtensions.JungleClearOption.AddBool("UsQEJungle", "Use Cannon Q");
            MyMenuExtensions.JungleClearOption.AddBool("UseWJungle", "Use Cannon W");
            MyMenuExtensions.JungleClearOption.AddBool("UseEJungle", "Use Cannon E");
            MyMenuExtensions.JungleClearOption.AddBool("UsQEJungleHam", "Use Hammer Q");
            MyMenuExtensions.JungleClearOption.AddBool("UseWJungleHam", "Use Hammer W");
            MyMenuExtensions.JungleClearOption.AddBool("UseEJungleHam", "Use Hammer E");
            MyMenuExtensions.JungleClearOption.AddBool("UseRJungle", "Use R Switch");
            MyMenuExtensions.JungleClearOption.AddMana();

            MyMenuExtensions.FleeOption.AddMenu();
            MyMenuExtensions.FleeOption.AddQ();
            MyMenuExtensions.FleeOption.AddE();
            MyMenuExtensions.FleeOption.AddR();

            MyMenuExtensions.KillStealOption.AddMenu();
            MyMenuExtensions.KillStealOption.AddQ();
            MyMenuExtensions.KillStealOption.AddE();
            MyMenuExtensions.KillStealOption.AddBool("UsQEEKS", "Use QE");
            ...
            MyMenuExtensions.MiscOption.AddBool("E", "forceGate", "Auto E| After Q", false);
            MyMenuExtensions.MiscOption.AddSlider("E", "gatePlace", "Gate Place Distance", 50, 50, 110);
            MyMenuExtensions.MiscOption.AddSlider("E", "autoE", "Auto E Save|When Player HealthPercent < x%", 20, 0, 101);
            MyMenuExtensions.MiscOption.AddSetting("QE");
            MyMenuExtensions.MiscOption.AddKey("QE", "SemiQE", "Semi-manual QE Key", Keys.T, KeyBindType.Press);
            MyMenuExtensions.MiscOption.AddList("QE", "SemiQEMode", "Semi-manual QE Mode", new[] { "To Target", "To Mouse" });

            MyMenuExtensions.DrawOption.AddMenu();
            MyMenuExtensions.DrawOption.AddRange(Q, "Cannon Q");
            MyMenuExtensions.DrawOption.AddRange(QE, "Cannon Q Extend");
            MyMenuExtensions.DrawOption.AddRange(W, "Cannon W");
            MyMenuExtensions.DrawOption.AddRange(E, "Cannon E");
            MyMenuExtensions.DrawOption.AddRange(Q, "Hammer Q");
            MyMenuExtensions.DrawOption.AddRange(W, "Hammer W");
            MyMenuExtensions.DrawOption.AddRange(E, "Hammer E");
            MyMenuExtensions.DrawOption.AddDamageIndicatorToHero(true, true, true, false, false);
            MyMenuExtensions.DrawOption.AddBool("DrawCoolDown", "Draw Spell CoolDown");
        ...
        private static void OnUpdate(EventArgs args)
        {
            ...
            if (MyMenuExtensions.MiscOption.GetBool("QE", "SemiQE").Enabled)
            {
                SemiQELogic();
            }

            if (MyMenuExtensions.FleeOption.isFleeKeyActive)
            {
                Flee();
            }
                ...
                case GameObjectType.AIHeroClient:
                    {
                        ...
                        if (target != null && target.IsValidTarget())
                        {
                            ...
                            {
                                if (MyMenuExtensions.ComboOption.GetBool("UseWCombo").Enabled)
                                {
                                     ...
                                     Orbwalker.ActiveMode == OrbwalkerMode.LaneClear && MyManaManager.SpellHarass)
                            {
                                if (MyMenuExtensions.HarassOption.HasEnouguMana() &&
                                    ...
                                    MyMenuExtensions.HarassOption.GetBool("UseWHarass").Enabled)
                                {
                                    if (target.InAutoAttackRange())
                                    {
                                        Orbwalker.ResetAutoAttackTimer();
        ...
        private static void OnCreate(GameObject sender)
        {
            if (sender == null || sender.Type != GameObjectType.MissileClient ||
                !MyMenuExtensions.MiscOption.GetBool("E", "forceGate").Enabled || eCd != 0 || !E.IsReady())
            {
                return;
            }
        ...
        {
            if (MyMenuExtensions.DrawOption.GetBool("DrawCoolDown").Enabled)
            {
                string msg;
        ...
        private static void CastQCannon(AIHeroClient target, bool useE)
        {
            ...
            if (qePred.Hitchance >= HitChance.High && qCd == 0 && eCd == 0 && useE)
            {
                var gateVector = Me.Position + 
                    Vector3.Normalize(target.PreviousPosition - Me.Position) * MyMenuExtensions.MiscOption.GetSlider("E", "gatePlace").Value;
        ...
        private static void CastQCannonMouse()
        {
            ...
            {
                if (MyMenuExtensions.MiscOption.GetList("QE", "SemiQEMode").Index == 1)
                {
                    var gateDis = MyMenuExtensions.MiscOption.GetSlider("E", "gatePlace").Value;
        ...
        private static bool ECheck(AIHeroClient target, bool usQE, bool useW)
        {
            ...
            if (Me.HealthPercent <= MyMenuExtensions.MiscOption.GetSlider("E", "autoE").Value)
            {
                return true;
            }
