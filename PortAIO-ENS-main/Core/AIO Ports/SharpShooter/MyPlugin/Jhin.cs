...
namespace SharpShooter.MyPlugin
{
    ...
    public class Jhin : MyLogic
    {
        ...
        private static void Initializer()
        {
            ...
            W.SetSkillshot(0.75f, 40f, 5000f, false,SpellType.Line);

            E = new Spell(SpellSlot.E, 750f);
            E.SetSkillshot(0.50f, 120f, 1600f, false,SpellType.Circle);

            R = new Spell(SpellSlot.R, 3500f);
            R.SetSkillshot(0.21f, 80f, 5000f, true,SpellType.Line);
        ...
        private static void Combo()
        {
            ...
            if (ComboOption.UseQ && Q.IsReady())
            {
                ...
                else if (target.IsValidTarget(Q.Range + 300) && ComboOption.GetBool("ComboQMinion").Enabled)
                {
                    ...
                    {
                        var qPred =
                            Prediction.GetPrediction(new PredictionInput { Unit = target, Delay = 0.25f });
                        var bestQMinion =
        ...
        private static void OnProcessSpellCast(AIBaseClient sender, AIBaseClientProcessSpellCastEventArgs Args)
        {
            ...
            var spellslot = MyExtraManager.GetSpellSlotFromName(Me,spellName);
