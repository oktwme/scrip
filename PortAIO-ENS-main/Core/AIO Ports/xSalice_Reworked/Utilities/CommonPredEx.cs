...
namespace xSalice_Reworked.Utilities
{
    ...
    public class CommonPredEx
    {
        ...
        public static PredictionOutput GetP(Vector3 pos, Spell spell, AIBaseClient target, bool aoe)
        {
            return Prediction.GetPrediction(new PredictionInput
            {
                Unit = target,
        ...
        public static PredictionOutput GetPCircle(Vector3 pos, Spell spell, AIBaseClient target, bool aoe)
        {
            return Prediction.GetPrediction(new PredictionInput
            {
                Unit = target,
