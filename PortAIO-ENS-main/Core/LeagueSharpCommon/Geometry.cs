...
namespace LeagueSharpCommon.Geometry
{
    ...
    public class Astar
    {
        public List<List<Node>> ConstructGrid(int sizeX , int sizeY, Vector2 center)
        {
            ...
            var boundingRadius = ObjectManager.Player.BoundingRadius;

            foreach(var minion in MinionManager.GetMinions(500,MinionManager.MinionTypes.All, MinionManager.MinionTeam.All))
            {
