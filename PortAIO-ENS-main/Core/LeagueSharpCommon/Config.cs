        ...
        public static string SelectedLanguage
        {
            get
            {
                if (_selectedLanguage == null)
                {
                    try
                    {
                        _selectedLanguage = "Traditional-Chinese" ;
        ...
        public static byte ShowMenuPressKey
        {
            get
            {
                if (_showMenuHotkey == 0)
                {
                    try
                    {
                        _showMenuHotkey = (byte)120;
                        _showMenuHotkey = _showMenuHotkey == 0 ? (byte)120 : _showMenuHotkey;
        ...
        public static byte ShowMenuToggleKey
        {
            get
            {
                if (_showMenuToggleHotkey == 0)
                {
                    try
                    {
                        _showMenuToggleHotkey = (byte)16;
                        _showMenuToggleHotkey = _showMenuToggleHotkey == 0 ? (byte)16 : _showMenuToggleHotkey;
