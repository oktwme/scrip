...
namespace LeagueSharpCommon.Notifications
{
    using System;
    ...
    public class Notification : INotification, IDisposable
    {
        ...
        public void OnDraw()
        {
            ...
            this.Font.DrawText(
                this.sprite,
                finalText,
                rectangle.Left + (rectangle.Width - textDimension.Width) / 0x2,
                rectangle.Left + (rectangle.Height - textDimension.Height) / 0x2,
                this.TextColor);
                ...
                case NotificationState.Idle:
                    {
                        ...
                        var t = Math.Max(0, this.startT + this.duration - Environment.TickCount + 500);
                        ...
                        if (location != -0x1 && this.position.Y > location)
                        {
                            ...
                            this.moveStartT = Environment.TickCount;
                ...
                case NotificationState.AnimationMove:
                    {
                        ...
                        {
                            var percentT = Math.Min(1, ((float)Environment.TickCount - this.moveStartT) / 500);
        ...
        public void OnWndProc(GameWndEventArgs args)
        {
            if (Utils.IsUnderRectangle(Utils.GetCursorPos(), this.position.X, this.position.Y, this.line.Width, 25f))
            {
                #region Mouse

                var message = (WindowsKeyMessages)args.Msg;
                if (message == WindowsKeyMessages.LBUTTONDOWN)
                {
        ...
        public bool Show(int newDuration = -0x1)
        {
            ...
            this.startT = Environment.TickCount;
