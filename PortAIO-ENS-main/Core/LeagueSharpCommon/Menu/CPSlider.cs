...
namespace LeagueSharpCommon
{
    ...
    public class CPSlider
    {
        ...
        public CPSlider(int x, int y, int height, float percent = 1)
        {
            this.xPos = x;
            this.yPos = y;
            this.Height = height - Properties.Resources.CPActiveSlider.Height;
            this.percent = percent;

            this.ActiveSprite = new Render.Sprite(Properties.Resources.CPActiveSlider, new Vector2(this.X, this.Y));
            this.InactiveSprite = new Render.Sprite(Properties.Resources.CPInactiveSlider, new Vector2(this.X, this.Y));
        ...
        public int Width
        {
            get
            {
                return Properties.Resources.CPActiveSlider.Width;
            }
        }
            ...
            switch (args.Msg)
            {
                case WindowsMessages.WM_LBUTTONDOWN:
                    if (Utils.IsUnderRectangle(
                        ...
                        this.Y,
                        this.Width,
                        this.Height + Properties.Resources.CPActiveSlider.Height))
                    {
        ...
        {
            this.Percent = (Utils.GetCursorPos().Y - (Properties.Resources.CPActiveSlider.Height / 2f) - this.Y) / this.Height;
