...
namespace Challenger_Series.Utils
{
    public class VectorHelper
    {
        ...
        public static List<AIBaseClient> GetDashObjects(IEnumerable<AIBaseClient> predefinedObjectList = null)
        {
            var objects = predefinedObjectList != null ? predefinedObjectList.ToList() : ObjectManager.Get<AIBaseClient>().Where(o => o.IsValidTarget(ObjectManager.Player.GetRealAutoAttackRange())).ToList();
