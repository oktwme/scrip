...
namespace Challenger_Series.Utils.Logic
{
    ...
    internal class PositionSaverCore
    {
        ...
        /// </summary>
        private static string PositionSaverDirectory = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + @"\EloBuddy\Challenger Series\"+ObjectManager.Player.Name+@"\Position Saver\";
