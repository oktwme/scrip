...
namespace Jayce.Extensions
{
    ...
    internal class Other
    {
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static double CannonQDmg(AIBaseClient target)
        {
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static double CannonQEDmg(AIBaseClient target)
        {
            return ObjectManager.Player.CalculateDamage(
                target,
                DamageType.Physical,
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static double ComboDamage(AIBaseClient target)
        {
            double damage = 0;
        ...
        /// The <see cref="double"/>.
        /// </returns>
        public static double HammerEDmg(AIBaseClient target)
        {
            return ObjectManager.Player.CalculateDamage(
                target,
                DamageType.Physical,
