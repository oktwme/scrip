    ...
    internal class SkinChance
    {
        ...
        public static void Inject()
        {
            ...
            var SkinMenu = Menu.Add(new Menu("SkinChance", "Skin Chance"));
            {
                ...
                {
                    case "Ahri":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Ahri));
                        break;
                    case "Akali":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Akali));
                        break;
                    case "Ashe":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Ashe));
                        break;
                    case "Blitzcrank":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Blitzcrank));
                        break;
                    case "Darius":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Darius));
                        break;
                    case "Ezreal":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Ezreal));
                        break;
                    case "Graves":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Graves));
                        break;
                    case "Hecarim":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Hecarim));
                        break;
                    case "Illaoi":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Illaoi));
                        break;
                    case "Karma":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Karma));
                        break;
                    case "Riven":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Riven));
                        break;
                    case "Sivir":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Sivir));
                        break;
                    case "Tristana":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Tristana));
                        break;
                    case "TwistedFate":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) TwistedFate));
                        break;
                    case "Twitch":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Twitch));
                        break;
                    case "Vayne":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Vayne));
                        break;
                    case "Viktor":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Viktor));
                        break; 
                    case "Vladimir":
                        SkinMenu.Add(new MenuList("SkinName", "Select Skin", (string[]) Vladimir));
                        break;
                    default:
                        break;
                }
        ...
        private static void OnUpdate(EventArgs Args)
        {
            ...
            if (Menu["SkinChance"].GetValue<MenuBool>("Enable").Enabled)
            {
            }
            else if (!Menu["SkinChance"].GetValue<MenuBool>("Enable").Enabled)
            {
            }
        }
