    ...
    public static class Geometry
    {
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                var innerCenters = LeagueSharpCommon.Geometry.Geometry.CircleCircleIntersection(Start, End, innerRadius, innerRadius);
                var outerCenters = LeagueSharpCommon.Geometry.Geometry.CircleCircleIntersection(Start, End, outerRadius, outerRadius);
