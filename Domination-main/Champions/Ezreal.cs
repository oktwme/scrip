...
namespace DominationAIO.Champions
{
    ...
    internal class Ezreal
    {
        ...
        public static void Ezreal_Load()
        {
            ...
            keys.Add(EzKeysSetting.SemiRKey).AddPermashow();
            keys.Add(EzKeysSetting.FarmKey).AddPermashow();
            keys.Add(EzKeysSetting.HarassKey).AddPermashow();
            keys.Add(EzKeysSetting.Stacks).AddPermashow();
            keys.Add(EzKeysSetting.Flee).AddPermashow();
