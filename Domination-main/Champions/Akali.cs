...
namespace DominationAIO.Champions
{
    ...
    internal class Akali
    {
        ...
        public static void OnLoad()
        {
            ...
            E2Menu.Add(AkaliMenu.ESettings.E2Use.TurretE2).AddPermashow();
            Emenu.Add(E2Menu);


            Rmenu.Add(AkaliMenu.RSettings.Rcombo).AddPermashow();
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                Drawing.DrawCircleIndicator(Player.Position, Player.GetCurrentAutoAttackRange(), System.Drawing.Color.White);
            }
            else
            {
                Drawing.DrawCircleIndicator(Player.Position, Q.Range, System.Drawing.Color.Blue);
            }
            ...
            {
                Drawing.DrawCircleIndicator(target.Position, 70, System.Drawing.Color.Gold);
            }
        }
