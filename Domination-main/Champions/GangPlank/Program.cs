...
namespace e.Motion_Gangplank
{
    internal class Program
    {
        ...
        {           
            ...
            {
                Drawing.DrawCircleIndicator(Player.Position, Q.Range, Color.IndianRed);
            }
            if (Config.Menu["Drawings"]["drawings.e"].GetValue<MenuBool>().Enabled && E.IsReady())
            {
                Drawing.DrawCircleIndicator(Player.Position, E.Range, Color.IndianRed);
            }
        }
