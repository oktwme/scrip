...
namespace DominationAIO.NewPlugins
{
    public static class EventsIrelia
    {
        ...
        public static void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                Drawing.DrawCircleIndicator(ObjectManager.Player.Position, Irelia.Q.Range, System.Drawing.Color.Red);
                Drawing.DrawCircleIndicator(Game.CursorPos, 150f, (Variables.GameTimeTickCount - Irelia.SheenTimer > 1600) ? System.Drawing.Color.Green : System.Drawing.Color.Red);
            }
            ...
            if (MenuSettings.ClearSettings.DrawMinions.Enabled)
            {
                ...
                if(minions != null)
                {
                    ...
                    {
                //        Drawing.DrawLine(min.Position, 70f, 10, System.Drawing.Color.Red);
