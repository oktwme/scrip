...
namespace DominationAIO.NewPlugins
{
    public static class MyYone
    {
        ...
        {
            if(pos != Vector3.Zero)
                Drawing.DrawCircleIndicator(pos, 50, System.Drawing.Color.Red);
        }
        ...
        private static void LoadMenu()
        {
            ...
            Keys.Add(YoneMenu.Keys.TurretKey).AddPermashow();
            Keys.Add(YoneMenu.Keys.SemiE).AddPermashow();
            Keys.Add(YoneMenu.Keys.SemiR).AddPermashow();
