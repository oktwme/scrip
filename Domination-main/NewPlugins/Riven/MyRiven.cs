    ...
    public static class MyRiven
    {
        ...
        public static void LoadRiven()
        {
            ...
            try
            {
                ...
                rcombo.Add(RivenMenu.Rmenu.ToggleKey).AddPermashow();
                rcombo.Add(RivenMenu.Rmenu.UseR1);
                rcombo.Add(RivenMenu.Rmenu.UseR2);


                var key = new Menu("key", "Keys Settings");
                key.Add(RivenMenu.Keys.BurstCombo).AddPermashow();
                key.Add(RivenMenu.Keys.AutoSelect).AddPermashow();
                key.Add(RivenMenu.Keys.FlashW).AddPermashow();
                key.Add(RivenMenu.Keys.Flee).AddPermashow();
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
            ...
            Drawing.DrawCircleIndicator(ObjectManager.Player.Position, Q.Range, System.Drawing.Color.Red);
        }
