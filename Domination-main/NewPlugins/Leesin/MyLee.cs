...
namespace DominationAIO.NewPlugins
{
    public static class MyLee
    {
        ...
        private static void Drawing_OnEndScene1(EventArgs args)
        {
            if (LeeMenu.LeeR.LogicInsec.Active)
            {
                ...
                if (insectarget != null)
                {
                    Drawing.DrawCircleIndicator(insectarget.Position, 100, System.Drawing.Color.Black);
                    Drawing.DrawCircleIndicator(pos, 100, System.Drawing.Color.Blue);
        ...
        private static void Drawing_OnEndScene(EventArgs args)
        {
            ...
            if (obj != null)
                Drawing.DrawCircleIndicator(obj.Position, 50, System.Drawing.Color.White);
        }
        ...
        private static void DoWWrad()
        {
            ...
            if (LeeMenu.LeeKey.WWardKeyPress.Active && W.IsReady() && !isState2(W))
            {
                ...
                else
                {
                    ...
                    Drawing.DrawCircleIndicator(pos, 50, System.Drawing.Color.White);
    ...
    public static class LeeMenu
    {
        public static void MenuAttack(this Menu menu)
        {
            ...
            R.Add(LeeR.user);
            R.Add(LeeR.LogicInsec).AddPermashow();
            var key = new Menu("key", "Keys");
            key.Add(LeeMenu.LeeKey.WWardKeyPress).AddPermashow();
            key.Add(LeeKey.InSec).AddPermashow();
