...
namespace DominationAIO.NewPlugins.Katarina
{
    public static class MyKatarina
    {
        ...
        public static void LoadKata()
        {
            ...
            KMenu.Add(KataMenu.combomode).AddPermashow();
            ...
            Estg.Add(KataMenu.Emenu.SaveE).AddPermashow();

            Rstg.Add(KataMenu.Rmenu.RCombo).AddPermashow();
            Rstg.Add(KataMenu.Rmenu.NeverCancelR).AddPermashow();
            Rstg.Add(KataMenu.Rmenu.UseRifKS);
            Rstg.Add(KataMenu.Rmenu.Rcount);

            KMenu.Add(KataMenu.turret).AddPermashow();
            KMenu.Add(Qstg);
            KMenu.Add(Wstg);
            KMenu.Add(Estg);
            KMenu.Add(Rstg);
        ...
        private static void DrawingOnOnDraw(EventArgs args)
        {
            if (_daggersList != null)
            {
                foreach (var dagger in _daggersList)
                {
                    ...
                    {
                        Drawing.DrawCircleIndicator(dagger.Dagger.Position, 340, Color.DarkRed);
                        Drawing.DrawCircleIndicator(dagger.Dagger.Position, 150, Color.DarkRed);
                    }
                    else
                    {
                        Drawing.DrawCircleIndicator(dagger.Dagger.Position, 340, Color.Gold);
                        Drawing.DrawCircleIndicator(dagger.Dagger.Position, 150, Color.Chartreuse);
                    }
            ...
            Drawing.DrawCircleIndicator(ObjectManager.Player.Position, Q.Range, System.Drawing.Color.GreenYellow);
