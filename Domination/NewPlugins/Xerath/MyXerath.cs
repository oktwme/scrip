...
namespace DominationAIO.NewPlugins
{
    public static class MyXerath
    {
        ...
        public static void XerathLoad()
        {
            ...
            Rmenu.Add(XerathMenu.RMenu.RKey).AddPermashow();
            Rmenu.Add(XerathMenu.RMenu.CursorRange);
            Rmenu.Add(XerathMenu.RMenu.Select).AddPermashow();
        ...
        {
            Drawing.DrawCircleIndicator(Game.CursorPos, 200f, CheckTarget ? System.Drawing.Color.Red : System.Drawing.Color.Green);
        }
