...
namespace DominationAIO.NewPlugins
{
    public static class MenuSettings
    {
        public static void AttackToMenu(this Menu myMenu)
        {
            ...
            Keys.Add(MenuSettings.KeysSettings.TurretKey).AddPermashow();
            Keys.Add(MenuSettings.KeysSettings.FleeKey).AddPermashow();
            Keys.Add(MenuSettings.KeysSettings.SemiE).AddPermashow();
            Keys.Add(MenuSettings.KeysSettings.SemiR).AddPermashow();
            Keys.Add(MenuSettings.KeysSettings.AutoClearMinions).AddPermashow();
