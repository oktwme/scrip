    ...
    public class MyYS
    {
        ...
        public class YasuoMenu
        {
            ...
            public static void AddMenuYasuo()
            {
                ...
                yskeys.Add(YasuoMenu.Yasuo_Keys.Yasuo_Flee).AddPermashow();
                yskeys.Add(YasuoMenu.Yasuo_Keys.ComboEQ3Flash).AddPermashow();
                yskeys.Add(YasuoMenu.Yasuo_Keys.EQFlashKey).AddPermashow();
                yskeys.Add(YasuoMenu.Yasuo_Keys.TurretKey).AddPermashow();
                yskeys.Add(YasuoMenu.Yasuo_Keys.Yasuo_AutoQharass).AddPermashow();
                yskeys.Add(YasuoMenu.Yasuo_Keys.Yasuo_AutoStacks).AddPermashow();
                yskeys.Add(YasuoMenu.Yasuo_Keys.AutoQifDashOnTarget).AddPermashow("Auto Q in Dash", SharpDX.Color.Azure);
                ...
                Ecombo.Add(YasuoMenu.Ecombo.Yasuo_EMode).AddPermashow();
                ...
                Ecombo.Add(YasuoMenu.Ecombo.Yasuo_EziczacMode).AddPermashow(YasuoMenu.Ecombo.Yasuo_Eziczac.Enabled ? YasuoMenu.Ecombo.Yasuo_EziczacMode.SelectedValue : "Disabled", SharpDX.Color.Yellow);
                ...
                themenu.Add(YasuoMenu.UseExploit).AddPermashow();
            ...
            private static void Drawing_OnEndScene(EventArgs args)
            {
                ...
                if (CheckImDashing)
                {
                    Drawing.DrawCircleIndicator(ObjectManager.Player.Position, RangeCheck.EQrange.Value, System.Drawing.Color.Red);
                }
            }
