...
namespace DaoHungAIO.Champions
{
    class Kayle
    {
        ...
        private void Drawing_OnDraw(EventArgs args)
        {
            ...
            {
                Drawing.DrawCircleIndicator(Player.Position, q.Range, System.Drawing.Color.Red);
            }
            if (wdraw.Enabled && w.IsReady())
            {
                Drawing.DrawCircleIndicator(Player.Position, w.Range, System.Drawing.Color.Red);
            }
            if (edraw.Enabled && e.IsReady())
            {
                Drawing.DrawCircleIndicator(Player.Position, e.Range, System.Drawing.Color.Red);
            }
            if (rdraw.Enabled && r.IsReady())
            {
                Drawing.DrawCircleIndicator(Player.Position, r.Range, System.Drawing.Color.White);
            }
        }
        ...
        {
            Drawing.DrawCircle(args.To, 20, 10, System.Drawing.Color.Red);
