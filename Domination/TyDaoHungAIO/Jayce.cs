...
namespace DaoHungAIO.Champions
{
    public static class Jayce
    {
        ...
        {
            Notifications.Add(new NotificationItem("Dao Hung AIO fuck WWapper", "Jayce credit  Detusk"));
        ...
        private static void onDraw(EventArgs args)
        {
            ...
            if (!Config["draw"].GetValue<MenuBool>("drawCir").Enabled)
                return;
            Drawing.DrawCircleIndicator(Player.Position, !isHammer ? 1100 : 600, Color.Red);

            Drawing.DrawCircleIndicator(Player.Position, 1550, Color.Violet);
        }
    ...
    class HpBarIndicator
    {
        ...
        public static SharpDX.Direct3D9.Device dxDevice = Drawing.Direct3DDevice9;
