...
namespace DominationAIO.Champions
{
    internal static class SamiraSetMenu
    {
        ...
        public static void AddSamiraMenu(this Menu menu)
        {
            ...
            ESamira.Add(ESettings.EMinions).AddPermashow();
            ...
            KeysSamira.Add(KeysSettings.QMixed).AddPermashow();
            KeysSamira.Add(KeysSettings.QClear).AddPermashow();
            KeysSamira.Add(KeysSettings.AllowTurret).AddPermashow();
            KeysSamira.Add(KeysSettings.TurboFast).AddPermashow();
    ...
    public class Samira
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            if (!Player.IsDead)
            {
                ...
                {
                    Drawing.DrawCircleIndicator(Player.Position, Player.GetRealAutoAttackRange(), System.Drawing.Color.Red);
                    Drawing.DrawCircleIndicator(Player.Position, 900, System.Drawing.Color.Yellow);
                }
            }
        }
