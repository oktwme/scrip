...
namespace WafendAIO.Libraries
{
    ...
    class KurisuLib
    {
        ...
        static KurisuLib()
        {
			...
			//TODO: check if wall behind us with direction vector and collision
            CCList.Add(
                new KurisuLib
                {
                    HeroName = "Bard",
			...
			//TODO: Check if we have W Buff on us --> otherwise it doesn't interrupt us
            CCList.Add(
                new KurisuLib
                {
                    HeroName = "Brand",
			...
			//FIXME didn't check the SDataName
			CCList.Add(
			new KurisuLib
			{
				HeroName = "Cho'gath",
